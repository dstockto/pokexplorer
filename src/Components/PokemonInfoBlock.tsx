...
function renderAbilities(
  abilities: Ability[],
  setAbilityInfo: (info: AbilityInfo | null) => void
) {
  return (
    ...
    <div className={"pokemon-info"}>
      <div className={"column"}>
        <div>
          ...
          <span className={"data"}> {decimetersToFeetAndInches(height)}</span>
        </div>
        <div>
          <span className={"heading"}>Weight</span>{" "}
          <span className={"data"}>{hectogramsToPounds(weight)}</span>
        </div>
        <div>
          <span className={"heading"}>Gender</span>{" "}
          <span className={"data"}>{genderRateToIcons(genderRate)}</span>
        </div>
      </div>
      <div className={"column"}>
        <div>
          <span className={"heading"}>Category</span>{" "}
          <span className={"data"}>{generaToCategory(category)}</span>
        </div>
        <div>
          <span className={"heading"}>Abilities</span>{" "}
          <span className={"data"}>
            {renderAbilities(abilities, setAbilityInfo)}
          </span>
        </div>
      </div>
    </div>
